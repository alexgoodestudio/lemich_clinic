...
function Blog() {
  ...
  return (
    <div ref={containerRef} className="bg-slate-50 min-vh-100">
      <Helmet>
        <title>Mental Health Resources & Insights | The Lemich Clinic Blog</title>
        <meta name="description" content="Expert guidance on military mental health, VA disability claims, PTSD treatment, and therapy for active duty service members and veterans in Norfolk, VA." />
      </Helmet>
